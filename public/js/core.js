...
shopMaster.value("CategoryProvider", {
    categories: [
...
shopMaster.controller("CreateCtrl", function($scope, $location, $http, GucciKrogesService, UserProvider, CategoryProvider) {
    ...
    $scope.categories = CategoryProvider.categories;
...
shopMaster.controller("MobileCtrl", function($scope, $location, $http, UserProvider, GucciKrogesService) {
